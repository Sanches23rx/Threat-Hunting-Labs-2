...
По итогам выполненных заданий в лабораторной работе №1 были получены базовые навыки работы с языком R.

## Вывод

Таким образом, я изучил базовый синтаксис языка, научился работать с файлами и векторами.
